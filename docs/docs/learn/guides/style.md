...
You can also use a [dynamic parameter](../concepts/dynamic-parameters.md) to combine inline CSS and trial-specific variables. This allows you to easily apply the same inline CSS to multiple trials. Here's an example using a dynamic stimulus parameter and [timeline variables](../concepts/timeline.md#timeline-variables):
...
The syntax is "&lt;parameter-name> : &lt;parameter-value>". 
...
You may want the  `css_classes` parameter to vary across trials. If so, you can turn it into a [dynamic parameter](../concepts/dynamic-parameters.md) or use [timeline variables](../concepts/timeline.md#timeline-variables) (see examples below).
