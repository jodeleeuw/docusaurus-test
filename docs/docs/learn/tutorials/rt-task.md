---
title: Reaction-time task tutorial
description: Build a simple reaction-time experiment from scratch, covering many of jsPsych's core features.
---
# Reaction-time task tutorial
...
As explained on the [plugins documentation page](../concepts/plugins.md), the trial object must have a `type` parameter that tells jsPsych which plugin to use. 
...
The [media preloading section](../guides/media-preloading.md) goes into a lot of detail about various options for preloading and different ways that you can use this plugin. 
