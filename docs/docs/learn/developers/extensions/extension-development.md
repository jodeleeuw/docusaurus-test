...
For more information on the various types of parameters one can include in their data field, see our [documentation on `ParameterType`s](../plugins/plugin-development.md#parameter-types).
...
If you are developing an extension with the aim of including it in the main jsPsych repository we encourage you to follow the [contribution guidelines](learn/developers/contributing.md#contributing-to-the-codebase).
