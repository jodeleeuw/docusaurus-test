...
We've updated the [hello world tutorial](getting-started/hello-world.md) to walk through each of the three options. 
If you are looking for the option that is most similar to the version 6.x experience, check out [option 2](getting-started/hello-world.md#option-2-download-and-host-jspsych). 
...
See the ["Using a plugin" section](learn/researchers/overview/plugins.md#using-a-plugin) of the Plugins overview page for more examples.
